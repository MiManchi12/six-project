...
// 练习室我的练习室请求函数
export const reqMyTraining = () => request.get('/trainingCenter/plans/search/findByUserId?access_token=9b04591b-287b-4d95-88b0-7bcac75f6cd8&pageSize=20&pageNum=0&type=system')
